  ...
  return (
    <section className="relative h-dvh flex flex-col justify-center items-start md:items-center text-left md:text-center px-6 md:px-10">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <h1
          className="font-display text-[clamp(2.5rem,16vw,10rem)] font-bold leading-[0.88] tracking-tighter animate-in fade-in slide-in-from-bottom-6 duration-1000"
      ...
      {/* Bottom info strip */}
      <div
        className="absolute bottom-8 left-6 right-6 md:left-10 md:right-10 flex justify-end md:justify-between items-center animate-in fade-in duration-1000"
