...
export const projects: ProjectData[] = [
  {
    ...
    // video: '/videos/novabank-preview.mp4',
  ...
  },
  {
    ...
    // video: '/videos/techflow-preview.mp4',
  ...
  },
  {
    ...
    // video: '/videos/vitality-preview.mp4',
  ...
  },
  {
    ...
    // video: '/videos/meridian-preview.mp4',
    description: 'Brand identity and digital platform for a luxury real estate group — positioning them as the premium choice in a saturated market.',
    services: ['Brand Identity', 'Web Design', 'Front-end Development', 'Content Strategy'],
    challenge: 'Meridian had an outdated brand that didn\'t reflect the calibre of their portfolio. Their website was template-based and indistinguishable from competitors. They needed a complete rebrand and digital presence that matched their £50M+ property listings.',
    solution: 'We developed a refined brand identity built around restraint and precision — a custom logotype, limited colour palette, and typographic system. The website was built as a bespoke Next.js application with cinematic property showcases, map-based search, and a private client portal.',
    results: [
      { label: 'Enquiry Rate', value: '+85%' },
      { label: 'Time on Site', value: '+3.1min' },
      { label: 'Brand Perception (Survey)', value: '+42pts' },
    ],
    gallery: [
      { type: 'image', src: `${IMG}1512917774080-9991f1c4c750?q=80&w=2670&auto=format&fit=crop` },
      { type: 'image', src: `${IMG}1560518883-ce09059eeffa?q=80&w=2670&auto=format&fit=crop` },
    ],
  },
];
