...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    description: 'Generative AI platform that turns natural language into production-ready web apps. Describe what you want, and deploy a working prototype in under an hour.',
